...
class ObjectHandler:
    def __init__(self, game):
        ...
        add_sprite(AnimatedSprite(game, pos=(14.5, 14.5)))
        add_sprite(AnimatedSprite(game, pos=(14.5, 30.5)))
        add_sprite(AnimatedSprite(game, pos=(14.5, 20.5)))
        ...
        # add_npc(SoldierNPC(game, pos=(14.0, 9.0)))
        # add_npc(SoldierNPC(game, pos=(10.0, 2.0)))
        # add_npc(SoldierNPC(game, pos=(7.5, 4.5)))
        # add_npc(SoldierNPC(game, pos=(2.0, 17.0)))
        # add_npc(SoldierNPC(game, pos=(4.5, 35.0)))
        # add_npc(SoldierNPC(game, pos=(3.0, 7.0)))
        # add_npc(CacoDemonNPC(game, pos=(9.0, 4.5)))
        # add_npc(CacoDemonNPC(game, pos=(13.0, 2.5)))
        # add_npc(CacoDemonNPC(game, pos=(3.0, 27.5)))
        # add_npc(CyberDemonNPC(game, pos=(7.0, 4.9)))
